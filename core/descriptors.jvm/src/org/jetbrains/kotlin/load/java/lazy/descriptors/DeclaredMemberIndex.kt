...
interface DeclaredMemberIndex {
    ...
    fun hasRecordComponent(name: Name): Boolean
    ...
    object Empty : DeclaredMemberIndex {
        ...
        override fun hasRecordComponent(name: Name) = false
...
open class ClassDeclaredMemberIndex(
    ...
    override fun hasRecordComponent(name: Name): Boolean = name in components
